...
import { GitHubLogo, KeyIcon, MenuIcon, NavigationIcon, PersonLogo, TwitterLogo, XIcon } from './Icons';
      ...
      <Container openOnMobile={openOnMobile}>
        ...
        <Items>
          ...
          <div ref={dragConstraintsRef}>
            ...
            <Page active={pathname === '/citizenship' ? 1 : 0} to="/citizenship">
              cittadinanza
            </Page>
          </div>

          <Icons>
          <a href="https://e-z.bio/gattp">
              <KeyIcon />
            </a>
            <a href="https://twitter.com/gattpDEV">
              <TwitterLogo />
            </a>
            <a href="https://github.com/Gattp">
              <GitHubLogo />
            </a>
